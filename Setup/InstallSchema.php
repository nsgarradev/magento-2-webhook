    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_webhook_hook')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('grant_type', Table::TYPE_TEXT, 255, [], 'Grant Type')
                ->addColumn('client_id', Table::TYPE_TEXT, 255, [], 'Client ID')
                ->addColumn('client_secret', Table::TYPE_TEXT, 255, [], 'Client Secret')
                ->addColumn('access_token_url', Table::TYPE_TEXT, 255, [], 'Access Token URL')
